...
pub const DRYWATER: Problem = (
    "Drywater",
    "tests/drywatergulch.map",
    (175, 315),
    (320, 125),
);
pub const FLOODEDPLAINS: Problem = (
    "Flood Plains",
    "tests/FloodedPlains.map",
    (160, 100),
    (480, 330),
);
...
pub const WAYPOINTJUNCTION: Problem = (
    "Waypoint Junc",
    "tests/WaypointJunction.map",
    (245, 20),
    (260, 500),
);
