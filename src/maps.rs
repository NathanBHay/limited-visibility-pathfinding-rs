//! Contains the map data for a series of maps found from the Moving AI Lab, as well
//! as a few custom problems for specific S* testing.
...
/// Full map pack for testing
pub const MAP_PACK: [Problem; 13] = [
    MAP, WALL, FILL, CACAVERNS, DRYWATER,
    FLOODEDPLAINS, HRT, LAK, MAZE,
    MEDUSA, SIROCCO, TRISKELION,
    WAYPOINTJUNCTION,
];
